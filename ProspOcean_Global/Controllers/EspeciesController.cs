...
namespace ProspOcean_Global.Controllers
{
    public class EspeciesController : Controller
    {
        ...
        public EspeciesController(ProspOceanDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeComum,NomeCientifico,Descricao,Habitat")] Especie especie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeComum,NomeCientifico,Descricao,Habitat")] Especie especie)
        {
            if (id != especie.Id)
            {
                return NotFound();
